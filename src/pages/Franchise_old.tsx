...
import locationIcon from '@/assets/8836647751737711483location.png';
import revenueIcon from '@/assets/7262207221737951751revenue.png';
...
const statsData = [
  {
    ...
    value: 'High Streets, Highways',
  },
  {
    icon: revenueIcon,
    title: 'Revenue Channels',
    value: 'Dine-in (Oven Story Pizza), Takeaway and Delivery (Aggregator/EatSure)',
  },
];
